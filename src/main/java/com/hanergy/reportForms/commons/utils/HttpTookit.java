...
public class HttpTookit {
    ...
    private static String getResult(HttpRequestBase httpRequestBase) throws IOException {
        CloseableHttpResponse response = HTTP_CLIENT.execute(httpRequestBase);
    ...
    public static JSONObject HYPost(String url, Map<String,String> params, Map<String,String> heads){
        String result = doPost(url,params,heads);
        if(!org.springframework.util.StringUtils.isEmpty(result)){
    ...
    private static CredentialsProvider credentialsProvider(){
        ...
        provider.setCredentials(new AuthScope("api15.sapsf.cn",80),
